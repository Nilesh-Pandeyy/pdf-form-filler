...
def fill_pdf(input_path, output_path):
    data = {
        'day': "06",
        'monthx': "February",
        'year': "2025",
        'company_address': "S-12,Janta Market,Rajouri Garden,New Delhi-110059",
        'employee_name': "Nilesh Pandey",
        'employee_address': "Andheri east,Mumbai-400072",
        'company_rep_name': "Madhurima",
        'designation': "HR Manager",
        'current_date': datetime.now().strftime("%d/%m/%Y"),
        'witness_name': "Ayan Hazra",
        'employee_signature': "Nilesh Pandey",
        'witness_signature': "Ayan"
    }

    page_positions = {
        0: {
            'day': (426.905595, 842 - 143.94677784452153),
            'month': (72.0, 842 - 157.17065446952154),
